    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="font-black text-2xl text-green-600">AgendaFácil</Link>
          <h1 className="text-xl font-bold text-gray-900 mt-4">Entre na sua conta</h1>
          <p className="text-gray-500 text-sm mt-1">Ou crie uma nova gratuitamente</p>
        </div>

        {sent ? (
          <div className="text-center py-6">
            <div className="text-4xl mb-4">📧</div>
            <h2 className="font-bold text-gray-900 mb-2">Verifique seu email</h2>
